# RESIM DESCRIOPTION
The resim.jar file is an implementation of RESIM (REsource SIMilarity) measure. RESIM is presented in [1] and then is improved in [2] and the summary of the measure is presented in [3].
